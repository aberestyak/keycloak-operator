...
func (in *KeycloakRealmGroup) DeepCopyInto(out *KeycloakRealmGroup) {
	*out = *in
	...
	if in.SubGroup != nil {
		...
		*out = make([]KeycloakRealmSubGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeycloakRealmSubGroup) DeepCopyInto(out *KeycloakRealmSubGroup) {
	*out = *in
	if in.Access != nil {
		in, out := &in.Access, &out.Access
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeycloakRealmSubGroup.
func (in *KeycloakRealmSubGroup) DeepCopy() *KeycloakRealmSubGroup {
	if in == nil {
		return nil
	}
	out := new(KeycloakRealmSubGroup)
	in.DeepCopyInto(out)
	return out
}
